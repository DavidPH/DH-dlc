// HallAndZDoomDoor compound object

# include : "Hall.ddl"; // for Hall_ globals
# include : "ZDoomDoor.ddl";



# typedef new : HallAndZDoomDoor : compound object;

# default type : v1 : VERTEX : HallAndZDoomDoor;
# default type : v2 : VERTEX : HallAndZDoomDoor;
# default type : v3 : VERTEX : HallAndZDoomDoor;
# default type : v4 : VERTEX : HallAndZDoomDoor;

# default type : side1 : SIDEDEF : HallAndZDoomDoor;
# default type : side2 : SIDEDEF : HallAndZDoomDoor;

# default type : doorsize : float : HallAndZDoomDoor;

# default type : heightfloor   : int : HallAndZDoomDoor;
# default type : heightceiling : int : HallAndZDoomDoor;

# default type : texturefloor   : string : HallAndZDoomDoor;
# default type : textureceiling : string : HallAndZDoomDoor;
# default type : texturewall    : string : HallAndZDoomDoor;
# default type : texturedoor    : string : HallAndZDoomDoor;
# default type : texturetrak    : string : HallAndZDoomDoor;



# define : HallAndZDoomDoor
{
	...
	# if not exists local : side_door
		...
		side_door.texturetop = "$DOOR2_4";

		# if exists : ZDoomDoor_texturedoor
			{side_door.texturetop = ZDoomDoor_texturewall;}

		# if exists local : texturedoor
			{side_door.texturetop = texturedoor;}

		side_door.sector = hall_sector;
